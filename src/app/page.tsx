...
import { Loader2, AlertTriangle, Thermometer, Droplet, Wind } from "lucide-react"
...
export default function Home() {
  ...
  return (
    <div className="container py-4 md:py-6">
      <h1 className="text-xl md:text-2xl font-bold mb-4 md:mb-6 font-mono">Mumbai Health Dashboard</h1>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 md:gap-6">
        ...
        <DataCard
          ...
          status={
            data.environmentalData.waterQuality.ph >= 6.5 && data.environmentalData.waterQuality.ph <= 8.5
              ? "success"
              : "warning"
          }
      ...
      <div className="mt-4 md:mt-6">
        <Card className="w-full">
          <CardHeader className="pb-2">
            ...
            <CardDescription>
              Interactive map showing environmental sensors, disease outbreaks, and mental health reports
            </CardDescription>
          </CardHeader>
          <CardContent>
            <MapView
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              {data.diseaseOutbreaks.map((outbreak) => (
                <AlertCard
                  ...
                  description={`${outbreak.affectedAreas.reduce((sum, area) => sum + area.caseCount, 0)} cases reported`}
          ...
          <TabsContent value="environmental" className="mt-4">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <AlertCard
                ...
                severity={data.environmentalData.airQuality.aqi > 150 ? "high" : "medium"}
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              {data.mentalHealthReports.map((report) => (
                <AlertCard
                  ...
                  severity={
                    report.stressLevel > 7 || report.anxietyLevel > 7 || report.depressionLevel > 7
                      ? "high"
                      : report.stressLevel > 5 || report.anxietyLevel > 5 || report.depressionLevel > 5
                        ? "medium"
                        : "low"
                  }
